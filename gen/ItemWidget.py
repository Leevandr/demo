...
class Ui_ItemWidget(object):
    def setupUi(self, ItemWidget):
        ...
        self.verticalLayout_2.addWidget(self.label_description, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.label_brand = QtWidgets.QLabel(parent=ItemWidget)
        self.label_brand.setObjectName("label_brand")
        self.verticalLayout_2.addWidget(self.label_brand, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.label_category = QtWidgets.QLabel(parent=ItemWidget)
        self.label_category.setObjectName("label_category")
        self.verticalLayout_2.addWidget(self.label_category, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.label_title = QtWidgets.QLabel(parent=ItemWidget)
        self.label_title.setObjectName("label_title")
        self.verticalLayout_2.addWidget(self.label_title, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.label_discount = QtWidgets.QLabel(parent=ItemWidget)
        self.label_discount.setObjectName("label_discount")
        self.verticalLayout_2.addWidget(self.label_discount, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.horizontalLayout_2.addLayout(self.verticalLayout_2)
        self.label_price = QtWidgets.QLabel(parent=ItemWidget)
        self.label_price.setMinimumSize(QtCore.QSize(200, 50))
